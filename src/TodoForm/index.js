...
function TodoForm(){
    ...
    const onCancel = (event) => {event.preventDefault();setOpenModal(false)}
    ...
    return(
        <form onSubmit = {onSubmit}>
            ...
            <textarea placeholder='Hacer curso de React.js' value={newTodoValue} onChange={onChange} required/>
